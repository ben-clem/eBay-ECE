...
<body>
    ...
    <div class="page-container">
        ...
        <div class="content-wrap">
            ...
            <div id="section">
                <a href="items.php?id=100,110" class="zoom-out"> <img src="img/enc.jpg" height="200" width="200"> </a>
                <a href="items.php?id=001,011" class="zoom-out"> <img src="img/offre.jpg" height="200" width="200"> </a>
                <a href="items.php?id=010,110,011" class="zoom-out"> <img src="img/achat.jpg" height="200" width="200"> </a>
            </div>

            <div class="row mt-5 pt-5">
                <div class="col-4 text-center px-0 w-25" style="font-size: 125%; font-weight: bold; position: relative; left:5%;">
                    <p class="w-50 mx-auto mr-2">Vente aux enchères</p>
                </div>
                <div class="col-4 text-center px-0 w-25" style="font-size: 125%; font-weight: bold;">
                    <p class="w-50 mx-auto">Meilleure offre</p>
                </div>
                <div class="col-4 text-center px-0 w-25" style="font-size: 125%; font-weight: bold; position: relative; right:5%;">
                    <p class="w-50 mx-auto ml-2">Achats Immédiat</p>
                </div>
            </div>
