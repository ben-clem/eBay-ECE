...
<body>
	...
	<div class="page-container">
		...
		<div class="content-wrap">
			...
			<div id="section">
				<a href="items.php?id=1" class="zoom-out"> <img src="img/enc.jpg" height="200" width="200"> </a>
				<a href="items.php?id=2" class="zoom-out"> <img src="img/offre.jpg" height="200" width="200"> </a>
				<a href="items.php?id=3" class="zoom-out"> <img src="img/achat.jpg" height="200" width="200"> </a>
			</div>
