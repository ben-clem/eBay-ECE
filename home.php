...
<body>
    <div class="page-container">
        ...
        <div class="content-wrap">
                ...
                <div class="row mx-5">
                    ...
                    <div class="col-sm-4 portfolio-item">
                        <div class="card h-auto">
                            <h6 class=" mx-auto my-2 px-2" id ="second"><a class="link-black" href="#">venteUne1</a></h6>
                    ...
                    <div class="col-sm-4 portfolio-item">
                        <div class="card h-auto">
                            <h6 class=" mx-auto my-2 px-2" id ="second"><a class="link-black" href="#">venteUne2</a></h6>
                            <a href="#"><img class="card-img-top" src="http://placehold.it/700x400" alt=""></a>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 portfolio-item">
                        <div class="card h-auto">
                            <h6 class=" mx-auto my-2 px-2" id ="second"><a class="link-black" href="#">venteUne3</a></h6>
                            <a href="#"><img class="card-img-top" src="http://placehold.it/700x400" alt=""></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row my-2">
                    <h5 class="mx-auto px-2" id ="first">Laissez-vous tenter par nos différents modes d'acquisition :</h5>
                </div>
                    ...
                    <div class="col-sm-4 portfolio-item">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Indiquez-nous le prix maximum que vous seriez prêt à payer et nous
                    ...
                    <div class="col-sm-4 portfolio-item">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Achetez immédiatement l'objet qui vous plaît au prix indiqué par
                                    le
                                    vendeur.</p>
                            </div>
                        </div>
        ...
        <footer class="navbar-dark bg-ece mb-0 px-2 pt-3 pb-1">
            ...
            <div class="row mx-4 mb-0 my-1">
                <svg class="bi bi-building white" width="25px" height="25px" viewBox="0 0 18 18" fill="currentColor"
                ...
                <a class="link ml-3 mb-0 pl-2 lightgrey" href="https://goo.gl/maps/wKUyiYcg5y4VWvs27"
                    target="_blank">37, Quai de Grenelle, 75015 Paris, France</a>
            </div>

            <div class="row mx-4 mb-0 my-1">
                <svg class="bi bi-envelope white" width="25px" height="25px" viewBox="0 0 17 17" fill="currentColor"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
                ...
                <a class="link ml-3 mb-0 pl-2 lightgrey" href="mailto:ebay.ece.binks"
                    target="_blank">infos@ece-ebay.fr</a>
            </div>

            <div class="row mx-4 mb-0 my-2">
                <svg class="bi bi-phone white" width="25px" height="25px" viewBox="0 0 18 18" fill="currentColor"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd"
