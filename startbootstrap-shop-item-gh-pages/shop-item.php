        ...
        //Rappel : votre serveur = localhost | votre login = root | votre mot de pass = '' (rien)
                $db_handle = mysqli_connect('localhost', 'root', '' );
                      ...
                      <div class="col-lg-3">
                        ...
                        <div class="list-group">
                          ...
                          <button class="list-group-item" onclick="encherir()"> 
                            <div class ="bouton">Enchérir</div> <br> <div class = "info"> Enchère maximale : 300 Euros <br> Nombre d'enchères : 5 <br> Temps restant : 01:34:00  <br> <a href ="#" id="lol"> Ajouter au panier </a> <br><br>
                          </div>
                        </button> 
                        <?php } ?>
                        ...
                        <button class="list-group-item" onclick=""> 
                          <div class ="bouton"> Achat Immédiat </div> <div class = "info"> Prix : <br> <a href ="#" id="lol"> Ajouter au panier </a> <br> 
                        </div>
                      </button>
                  ...
                  <button class="list-group-item" onclick="offre()"> 
                   <div class ="bouton">Faire une offre</div> <div class = "info"> <a href ="#" id="lol"> Ajouter au panier </a>
                 </button>
                 <?php } ?>
